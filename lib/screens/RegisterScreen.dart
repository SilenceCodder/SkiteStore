...
import 'package:skitestore/viewmodel/SignUpViewModel.dart';
        ...
        children: <Widget>[
         ...
         GestureDetector(
              ...
              child: Row(
                ...
                children: <Widget>[
                Text('Already have an account?', style: AppTextStyle.subHeader2(context, Colors.red),),
